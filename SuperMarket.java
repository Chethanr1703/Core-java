class SuperMarket{
	...
	// static String re'equil= "Re'equil";
	...
	// static String elle18= "Elle18";
	 ...
	 String pistachio= "Pistachio";
			...
			String	iceCreams[]={vanilla,strawberry,kulfi,frozenYogurt,blueBell,cones,butterscotch,mintChocolateChip,cookiesCream,pistachio};
	 ...
	 String calvinKlein= "Calvin Klein";
			 ...
			 String  perfumes[]={titan,gucci,davidoff,fougere,parkAvenue,renee,wildStone,ajmal,theManCampany ,calvinKlein};
	 ...
	 String leafygreens= "Leafygreens";
			...
			String  groceries[]= {rice,egg,milk,bread,onion,tomatoes,freshfruits,maggi,pasta,leafygreens};
	 ...
	 String elle18= "Elle18";
			 ...
			 String  cosmetics[]={cetaphil,ponds,lakme,biotique,minimalist,earthen,theFaceShop,reequil,innisfree,elle18};
